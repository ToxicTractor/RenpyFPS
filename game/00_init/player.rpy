init python:
    ...
    class Player():
        ...
        def draw_2d(self, canvas, center_offset):
            ...
            canvas.line("#ff0", (self.pos_x + x_offset, self.pos_y + y_offset), (self.pos_x + x_offset + 1920 * math.cos(self.angle), self.pos_y + y_offset + 1920 * math.sin(self.angle)), 2)
            canvas.circle("#0f0", (self.pos_x + x_offset, self.pos_y + y_offset), 10)
