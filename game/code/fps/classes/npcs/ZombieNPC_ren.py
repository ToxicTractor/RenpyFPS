...
from game.code.fps.classes.npcs.NPC_ren import NPC
...
zombie_attack_anim = AnimationData("zombie_attack", 0.5)
zombie_idle_anim = AnimationData("zombie_idle", 0)
zombie_walk_anim = AnimationData("zombie_walk", 0.8, True)
zombie_hurt_anim = AnimationData("zombie_hurt", 0.4)
zombie_death_anim = AnimationData("zombie_death", 0.5)
