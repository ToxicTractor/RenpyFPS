...
from game.code.fps.classes.ObjectPool_ren import ObjectPool
from game.code.fps.classes.player.ammo.AmmoType_ren import ShotgunAmmoType
from game.code.fps.classes.player.weapons.Casing_ren import Casing
...
shotgun_idle_anim = AnimationData("shotgun_idle", None)
shotgun_shoot_anim = AnimationData("shotgun_shoot", 0.8)
shotgun_shell_anim = AnimationData("shotgun_shell", 0.3)
