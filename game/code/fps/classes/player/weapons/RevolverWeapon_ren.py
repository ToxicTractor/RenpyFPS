...
from game.code.fps.classes.player.ammo.AmmoType_ren import RevolverAmmoType
...
revolver_idle_anim = AnimationData("revolver_idle", None)
revolver_shoot_anim = AnimationData("revolver_shoot", 0.8)
revolver_reload_anim = AnimationData("revolver_reload", 1.2)
