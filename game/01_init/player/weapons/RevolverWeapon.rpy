...
define revolver_shoot_anim = AnimationData("revolver_shoot", 1.0)
define revolver_reload_anim = AnimationData("revolver_reload", 2.4)

image revolver_idle:
    "revolver_idle_01"

image revolver_shoot = Animation(
    "revolver_shoot_01", 0.05,
    "revolver_shoot_02", 0.05,
    "revolver_shoot_03", 0.05,
    "revolver_shoot_04", 0.05,
    "revolver_shoot_05", 0.2,
    "revolver_shoot_04", 0.2,
    "revolver_shoot_03", 0.2,
    "revolver_shoot_02", 0.2,
) # 1.0 seconds

image revolver_reload = Animation(
    "revolver_reload_01", 0.1,
    "revolver_reload_02", 0.1,
    "revolver_reload_03", 0.1,
    "revolver_reload_04", 0.1,
    "revolver_reload_05", 0.1,
    "revolver_reload_06", 0.1,
    "revolver_reload_07", 0.1,
    "revolver_reload_08", 0.1,
    "revolver_reload_09", 0.1,
    "revolver_reload_10", 0.1,
    "revolver_reload_11", 0.1,
    "revolver_reload_12", 0.1,
    "revolver_reload_13", 0.1,
    "revolver_reload_14", 0.1,
    "revolver_reload_15", 0.1,
    "revolver_reload_16", 0.1,
    "revolver_reload_17", 0.1,
    "revolver_reload_18", 0.1,
    "revolver_reload_19", 0.1,
    "revolver_reload_20", 0.1,
    "revolver_reload_05", 0.1,
    "revolver_reload_04", 0.1,
    "revolver_reload_03", 0.1,
    "revolver_reload_02", 0.1,
